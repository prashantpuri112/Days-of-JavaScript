...
for (let i = 0; i < bills.length; i++) {
    ...
    /*  Using const instead of let because in each iteration a new tip variable is gonna be created so we're not mutating
        we are not changing the original tip that we have declare in each iteration we will create a new one
    */
    tips.push(tip);
